...
pdata <- read.csv(file = "phenotype_table2.csv",row.names = 1)
# load the expression data
edata <- read.csv(file = "expression_table2.csv",row.names = 1)
...
selectLab <- c("GABRB3","PIM2","PTPRZ1","SOX2","CRABP1","SALL3",
               "MYCN","ITM2A","EDNRB","SEMA6A","POU5F1")
